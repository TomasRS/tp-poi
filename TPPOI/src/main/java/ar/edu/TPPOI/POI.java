...
public abstract class POI {
	...
	public boolean contiene(String unaPalabraClave) {
		try {
			return (palabrasClaves.stream().anyMatch(unAtributo -> this.estanContenidos(unaPalabraClave, unAtributo)));
		} catch (Exception excepcion) {
			return false;
		}
	}

	// Delego la comparacion en una biblioteca que baja todo el string a
	// minuscula
	// y hace el contains. Lo hice simetrico con respecto al uno incluido en el
	// otro
