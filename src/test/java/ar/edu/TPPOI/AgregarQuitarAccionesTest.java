...
public class AgregarQuitarAccionesTest extends AbstractPersistenceTest implements WithGlobalEntityManager {
	...
	public void init() {
		...
		RepositorioDeTerminales.agregarTerminal(terminalAbasto);
		RepositorioDeTerminales.agregarTerminal(terminalDevoto);
		RepositorioDeTerminales.agregarTerminal(terminalCaballito);
		RepositorioDeTerminales.agregarTerminal(terminalBelgrano);
